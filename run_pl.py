...
from utils import glue_output_modes
from utils import processors
from utils import glue_tasks_num_labels
...
class GLUETransformer(BaseTransformer):
    ...
    def prepare_data(self):
        ...
        args = self.hparams
        processor = processors.Mo5Processor()
    ...
    def validation_epoch_end(self, outputs: list) -> dict:
        ...
        logs = ret["log"]
        return {"val_loss": torch.tensor(logs["val_loss"]), "log": logs, "progress_bar": logs}
